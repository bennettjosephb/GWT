...
public class SummaryPresenter extends
		Presenter<SummaryPresenter.MyView, SummaryPresenter.MyProxy> {
	...
	public interface MyProxy extends ProxyPlace<SummaryPresenter> {
	}

	@Inject
	public SummaryPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
