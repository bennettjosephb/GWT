...
public class ProfileEditPresenter extends
		Presenter<ProfileEditPresenter.MyView, ProfileEditPresenter.MyProxy> {

	public interface MyView extends View {
	}

	@ProxyCodeSplit
	@NameToken(NameTokens.profileedit)
	public interface MyProxy extends ProxyPlace<ProfileEditPresenter> {
	}

	@Inject
	public ProfileEditPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
