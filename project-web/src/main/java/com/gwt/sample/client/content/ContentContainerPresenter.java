...
public class ContentContainerPresenter
		extends
		Presenter<ContentContainerPresenter.MyView, ContentContainerPresenter.MyProxy> {

	public interface MyView extends View {
	}

	@ProxyCodeSplit
	public interface MyProxy extends Proxy<ContentContainerPresenter> {
	}
	...
	@Inject
	public ContentContainerPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
