...
public class com_sample_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment {
   ...
   *   com.sample.client.gin.ClientModule.configure(ClientModule.java:45)
   */
  public java.lang.String get_Key$type$java$lang$String$_annotation$$com$sample$client$place$DefaultPlace$() {
    java.lang.String result = "profile";
    return result;
