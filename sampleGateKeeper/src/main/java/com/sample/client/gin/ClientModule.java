...
import com.sample.client.RestrictedView;
...
public class ClientModule extends AbstractPresenterModule {
	...
	protected void configure() {
		...
		bindPresenter(RestrictedPresenter.class,
				RestrictedPresenter.MyView.class, RestrictedView.class,
				RestrictedPresenter.MyProxy.class);
	}
}
