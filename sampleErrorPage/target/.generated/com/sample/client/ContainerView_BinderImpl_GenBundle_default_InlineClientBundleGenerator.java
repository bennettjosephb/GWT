...
public class ContainerView_BinderImpl_GenBundle_default_InlineClientBundleGenerator implements com.sample.client.ContainerView_BinderImpl_GenBundle {
  private static ContainerView_BinderImpl_GenBundle_default_InlineClientBundleGenerator _instance0 = new ContainerView_BinderImpl_GenBundle_default_InlineClientBundleGenerator();
  private void footerInitializer() {
    footer = new com.sample.client.ContainerView_BinderImpl_GenCss_footer() {
      ...
      public String getText() {
        return (".GKUHBP5BEI{background-color:" + ("#f1f1f1")  + ";height:" + ("35px")  + ";overflow:" + ("hidden")  + ";position:" + ("absolute")  + ";width:" + ("100%")  + ";}");
      }
  ...
  private void headerInitializer() {
    header = new com.sample.client.ContainerView_BinderImpl_GenCss_header() {
      ...
      public String getText() {
        return (".GKUHBP5BFI{background-color:" + ("#f1f1f1")  + ";}");
      }
