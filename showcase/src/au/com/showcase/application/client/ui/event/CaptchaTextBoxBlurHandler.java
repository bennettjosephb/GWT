...
public class CaptchaTextBoxBlurHandler implements BlurHandler {
	...
	@Inject
	public CaptchaTextBoxBlurHandler() {
	...
	public CaptchaTextBoxBlurHandler(DecoratedPopupPanel decoratedPopupPanel) {
