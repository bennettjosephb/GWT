...
public class MobileNumberTextBoxBlurHandler implements BlurHandler {
	...
	@Inject
	public MobileNumberTextBoxBlurHandler() {
	...
	public MobileNumberTextBoxBlurHandler(DecoratedPopupPanel decoratedPopupPanel) {
