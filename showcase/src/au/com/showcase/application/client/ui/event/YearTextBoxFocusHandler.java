...
public class YearTextBoxFocusHandler implements FocusHandler {
	...
	@Inject
	public YearTextBoxFocusHandler() {
	...
	public YearTextBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
