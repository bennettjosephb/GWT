...
public class CaptchaTextBoxFocusHandler implements FocusHandler {
	...
	@Inject
	public CaptchaTextBoxFocusHandler() {
	...
	public CaptchaTextBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
