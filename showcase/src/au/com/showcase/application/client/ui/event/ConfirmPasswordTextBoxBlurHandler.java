...
public class ConfirmPasswordTextBoxBlurHandler implements BlurHandler {

	@Inject
	public ConfirmPasswordTextBoxBlurHandler() {
	...
	public ConfirmPasswordTextBoxBlurHandler(
			DecoratedPopupPanel decoratedPopupPanel, Label errorLabel) {
	...
	public void onBlur(BlurEvent event) {
		...
		if (textBox.getText() == null || textBox.getText().trim().equals("")) {
			...
			if (PasswordTextBoxFocusHandler.FOCUSED
					&& !dependentPassword.getText().equals(textBox.getText())) {
				errorLabel.setVisible(true);
			} else {
				setError(false);
