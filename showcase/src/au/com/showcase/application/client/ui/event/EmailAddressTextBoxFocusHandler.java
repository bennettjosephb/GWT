...
public class EmailAddressTextBoxFocusHandler implements FocusHandler {
	...
	@Inject
	public EmailAddressTextBoxFocusHandler() {
	...
	public EmailAddressTextBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
