...
public class MobileNumberTextBoxFocusHandler implements FocusHandler {
	...
	@Inject
	public MobileNumberTextBoxFocusHandler() {
	...
	public MobileNumberTextBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
