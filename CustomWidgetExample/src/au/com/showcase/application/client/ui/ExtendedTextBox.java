...
public class ExtendedTextBox extends ExtendedTextBoxBase {
	...
	/*
	 * @Inject public ExtendedTextBox(TextBoxBlurHandler textBoxBlurHandler,
	 * 
	 ...
	 * addClickHandler(textBoxClickHandler); addBlurHandler(textBoxBlurHandler);
	 * addMouseDownHandler(textBoxMouseDownHandler);
	 * addFocusHandler(textBoxFocusHandler);
	 * addKeyDownHandler(textBoxKeyDownHandler);
	 * addKeyPressHandler(textBoxKeyPressHandler);
	 * addKeyUpHandler(textBoxKeyUpHandler);
	 * addMouseMoveHandler(textBoxMouseMoveHandler);
	 * addMouseOutHandler(textBoxMouseOutHandler);
	 * addMouseOverHandler(textBoxMouseOverHandler);
	 * addMouseUpHandler(textBoxMouseUpHandler);
	 * addMouseWheelHandler(textBoxMouseWheelHandler);
	 * addMouseOverHandler(textBoxMouseOverHandler); }
	 */
}
