...
public class LineChartPresenter extends
		Presenter<LineChartPresenter.MyView, LineChartPresenter.MyProxy> {
	...
	@ProxyCodeSplit
	@NameToken(NameTokens.linechart)
	public interface MyProxy extends ProxyPlace<LineChartPresenter> {
	}

	@Inject
	public LineChartPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
	...
	protected void onBind() {
		...
		Runnable onLoadCallback = new Runnable() {
			...
			@Override
			public void run() {
				LineChart pieChart = new LineChart(createTable(), createOptions());
