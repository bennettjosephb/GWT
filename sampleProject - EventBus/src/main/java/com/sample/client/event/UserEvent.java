...
public class UserEvent extends GwtEvent<UserEvent.UserHandler> {
	...
	public UserEvent(String firstName, String lastName) {
		this.firstName = (firstName == null || firstName.trim().equals("")) ? "EMPTY VALUE ENTEREDEMPTY VALUE ENTERED" : firstName ;
		this.lastName = (lastName == null || lastName.trim().equals("")) ? "EMPTY VALUE ENTEREDEMPTY VALUE ENTERED" : lastName ;
	}
