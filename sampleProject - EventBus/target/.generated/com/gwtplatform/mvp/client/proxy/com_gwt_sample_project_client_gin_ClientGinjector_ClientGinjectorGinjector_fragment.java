...
public class com_gwt_sample_project_client_gin_ClientGinjector_ClientGinjectorGinjector_fragment {
  ...
  public com.gwtplatform.mvp.client.proxy.PlaceManager get_Key$type$com$gwtplatform$mvp$client$proxy$PlaceManager$_annotation$$none$$() {
    ...
    com.gwtplatform.mvp.client.proxy.PlaceManager result = injector.getFragment_com_gwt_sample_project_client_place().get_Key$type$com$gwt$sample$project$client$place$ClientPlaceManager$_annotation$$none$$();
