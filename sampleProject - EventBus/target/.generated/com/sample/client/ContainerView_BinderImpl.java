...
public class ContainerView_BinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.sample.client.ContainerView>, com.sample.client.ContainerView.Binder {
  ...
  class Widgets {
    ...
    /**
     * Getter for menu called 2 times. Type: GENERATED_CSS. Build precedence: 1.
     */
    private com.sample.client.ContainerView_BinderImpl_GenCss_menu menu;
    ...
    private com.sample.client.ContainerView_BinderImpl_GenCss_menu build_menu() {
      // Creation section.
      menu = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().menu();
      // Setup section.
      menu.ensureInjected();
    ...
    private com.google.gwt.user.client.ui.DockLayoutPanel build_f_DockLayoutPanel1() {
      ...
      f_DockLayoutPanel1.addEast(get_eastPanel(), 200);
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_centerPanel() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel centerPanel = new com.google.gwt.user.client.ui.HTMLPanel(template_html3().asString());
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.HTMLPanel build_westPanel() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel westPanel = new com.google.gwt.user.client.ui.HTMLPanel(template_html4().asString());
      // Setup section.
    ...
    /**
     * Getter for eastPanel called 1 times. Type: DEFAULT. Build precedence: 2.
     */
    private com.google.gwt.user.client.ui.HTMLPanel get_eastPanel() {
      return build_eastPanel();
    }
    private com.google.gwt.user.client.ui.HTMLPanel build_eastPanel() {
      // Creation section.
      final com.google.gwt.user.client.ui.HTMLPanel eastPanel = new com.google.gwt.user.client.ui.HTMLPanel(template_html5().asString());
      // Setup section.
      eastPanel.setStyleName("" + get_menu().menu() + "");
      eastPanel.setHeight("100%");
      eastPanel.setWidth("200px");


      owner.eastPanel = eastPanel;
