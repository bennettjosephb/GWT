...
public class SignUpPresenter extends
		Presenter<SignUpPresenter.MyView, SignUpPresenter.MyProxy> {
	...
	@Inject
	public SignUpPresenter(final EventBus eventBus, final MyView view,
			final MyProxy proxy) {
	...
	protected void revealInParent() {
		RevealContentEvent.fire(this,
				NewRegistrationContainerPresenter.MAIN_CONTENT_SLOT, this);
	}
