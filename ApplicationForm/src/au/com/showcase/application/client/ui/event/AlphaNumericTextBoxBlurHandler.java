...
public class AlphaNumericTextBoxBlurHandler implements BlurHandler {
	...
	@Inject
	public AlphaNumericTextBoxBlurHandler() {
	...
	public AlphaNumericTextBoxBlurHandler(DecoratedPopupPanel decoratedPopupPanel) {
