...
public class AlphaNumericTextBoxFocusHandler implements FocusHandler {
	...
	@Inject
	public AlphaNumericTextBoxFocusHandler() {
	}
	...
	public AlphaNumericTextBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
