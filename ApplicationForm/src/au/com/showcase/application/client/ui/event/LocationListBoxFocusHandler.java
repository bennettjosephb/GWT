...
public class LocationListBoxFocusHandler implements FocusHandler {
	...
	public LocationListBoxFocusHandler() {

	}

	public LocationListBoxFocusHandler(DecoratedPopupPanel decoratedPopupPanel) {
